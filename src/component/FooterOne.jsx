            ...
            <div className="footer-left-content">
              ...
              <div className="contact-column">
                  ...
                  <div className="contact-info inline">
                    ...
                    <a href="tel:+17866736887" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
                    ...
                    <a href="mailto:info@molotovfilms.com" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
