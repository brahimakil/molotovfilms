            ...
            <div className="footer-left-content">
              ...
              <div className="contact-column">
                  ...
                  <div className="contact-info inline" style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                    <p style={{ listStyle: 'none', margin: '8px 0', padding: 0 }}>Coupure 88a, 9000 Gent</p>
                    <p style={{ listStyle: 'none', margin: '8px 0', padding: 0 }}>Shelton St. London, England</p>
                    <a href="tel:+17866736887" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none', margin: '8px 0', padding: 0 }}>
                    ...
                    <a href="mailto:info@molotovfilms.com" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none', margin: '8px 0', padding: 0 }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
